...
export const run_simulation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
export const __wbg_simulationparams_free: (a: number, b: number) => void;
export const __wbg_get_simulationparams_pop_size: (a: number) => number;
export const __wbg_set_simulationparams_pop_size: (a: number, b: number) => void;
...
export const __wbg_get_simulationparams_elite_rate: (a: number) => number;
export const __wbg_set_simulationparams_elite_rate: (a: number, b: number) => void;
