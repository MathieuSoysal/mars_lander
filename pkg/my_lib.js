...
const SimulationParamsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_simulationparams_free(ptr >>> 0, 1));

export class SimulationParams {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SimulationParamsFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     */
    get nb_generations() {
        const ret = wasm.__wbg_get_simulationparams_nb_generations(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set nb_generations(arg0) {
        wasm.__wbg_set_simulationparams_nb_generations(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get crossover_rate() {
        const ret = wasm.__wbg_get_simulationparams_crossover_rate(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
    ...
    set crossover_rate(arg0) {
        wasm.__wbg_set_simulationparams_crossover_rate(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get mutation_rate() {
        const ret = wasm.__wbg_get_simulationparams_mutation_rate(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
    ...
    set mutation_rate(arg0) {
        wasm.__wbg_set_simulationparams_mutation_rate(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get elite_rate() {
        const ret = wasm.__wbg_get_simulationparams_elite_rate(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set elite_rate(arg0) {
        wasm.__wbg_set_simulationparams_elite_rate(this.__wbg_ptr, arg0);
    }
}
if (Symbol.dispose) SimulationParams.prototype[Symbol.dispose] = SimulationParams.prototype.free;
 ...
 * @param {number} elite_rate
 * @returns {string[]}
 */
export function run_from_web(map, pop_size, nb_generations, crossover_rate, mutation_rate, elite_rate) {
    const ptr0 = passStringToWasm0(map, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_from_web(ptr0, len0, pop_size, nb_generations, crossover_rate, mutation_rate, elite_rate);
